    ...
    <>
      ...
      <Page FULL customYMargin="my-1" className="">
        <div className="min-h-full">
          <Popover as="header" className="bg-indigo-600 py-24">
            <div className="relative isolate">
              <div className="bg-black/50 px-6 py-24 sm:py-16 lg:px-8">
                <img
                  src="https://res.cloudinary.com/dyb0qa58h/image/upload/v1693553673/49981990_xtn8kc.webp"
                  alt="whatever"
